...
hl.bind(mainMod .. " + " .. secondMod .. " + V", hl.dsp.exec_cmd(programs.clean_area_transf))

-- Screenshot
hl.bind(mainMod .. " + " .. thirdMod .. " + S", hl.dsp.exec_cmd(programs.screen_shot_region))
hl.bind(mainMod .. " + PRINT", hl.dsp.exec_cmd(programs.screen_shot_region))
hl.bind(mainMod .. " + " .. thirdMod .. " + M", hl.dsp.exec_cmd(programs.screen_shot_fullscreen))
...
hl.bind(mainMod .. " + " .. thirdMod .. " + F", hl.dsp.window.fullscreen())
...
-- ---------------- FN KEYS VOLUME, MEDIA AND MICROPHONE CONTROL ------------------
...
hl.bind(mainMod .. " + " .. secondMod .. " + M", hl.dsp.exec_cmd(programs.mic_mute))

hl.bind("XF86AudioPlay", hl.dsp.exec_cmd(programs.media_play_pause))
hl.bind("XF86AudioPrev", hl.dsp.exec_cmd(programs.media_previous))
hl.bind("XF86AudioNext", hl.dsp.exec_cmd(programs.media_next))
