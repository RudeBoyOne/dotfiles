...
$email = uwsm-app -- thunderbird
$color_picker = uwsm-app -- hyprpicker --autocopy
$area_transf = $ipc plugin:clipper toggle
$clean_area_transf = ~/.config/hypr/scripts/clean-area-transf.sh 
$emoji = $ipc launcher emoji
$screen_shot_not_save = uwsm-app -- hyprshot -z -m region --clipboard-only
